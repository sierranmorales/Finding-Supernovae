...
#
# Implants false supernovae into a duplicate data set (the data being marked as either sn for supernovae added, or orig for original)
#
...
for match in tqdm(visits_that_match, desc="Processing matches", unit="match"):
    ...
    # Save locations of supernovae to text file
    outputFile = f"visit_{match[0]}_{match[1]}_sn"
